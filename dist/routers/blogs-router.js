...
const validateParamsID_1 = require("../utils/common-utils/validateParamsID");
exports.blogsRouter = express_1.default.Router({});
//TODO: GET LIST OF BLOGS
exports.blogsRouter.get("/", blogsController_1.getBlogs);
//TODO: GET BLOG BY ID
exports.blogsRouter.get("/:id", validateParamsID_1.validateParamsID, blogsController_1.getBlogsById);
...
exports.blogsRouter.put("/:id", basicAuth_1.basicAuthMiddleware, validateParamsID_1.validateParamsID, blogsValidator_1.blogsValidator, responseErrorValidationMiddleware_1.responseErrorValidationMiddleware, blogsController_1.updateBlogById);
//TODO: DELETE BLOG BY ID
exports.blogsRouter.delete("/:id", basicAuth_1.basicAuthMiddleware, validateParamsID_1.validateParamsID, blogsController_1.deleteBlogById);
