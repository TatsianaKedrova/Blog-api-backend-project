import { PostInputModel } from "./../src/dto/postsDTO/PostModel";
...
describe("API for posts", () => {
  ...
  test("CREATE a new post with CORRECT input data and return status 201", async () => {
    ...
    console.log("blog: ", createdBlog.id);
    ...
    console.log("post respinse: ", postResponse.body);
